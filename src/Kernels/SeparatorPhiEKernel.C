...
InputParameters
SeparatorPhiEKernel::validParams()
{
...
Real
SeparatorPhiEKernel::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real t0 = 0.0107907 + _couple_c[_qp] * 1.48837e-4;
  Real dt0 = 1.48837e-4;
  Keff = _K * _eps * sqrt(_eps);
