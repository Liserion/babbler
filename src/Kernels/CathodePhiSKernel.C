...
Real
CathodePhiSKernel::OpenCircuitV(const int & matechoice, Real x)
{
  Real V = 0.0;
...
void
CathodePhiSKernel::BV(const Real & c, const Real & phi1, const Real & phi2, const Real & cs,
...
Real
CathodePhiSKernel::computeQpResidual()
{
...
Real
CathodePhiSKernel::computeQpJacobian()
{
  BV(_couple_c[_qp], _u[_qp], _couple_phi2[_qp], _couple_cs[_qp], Jeff, dJdc, dJdphi1, dJdphi2);
...
Real
CathodePhiSKernel::computeQpOffDiagJacobian(unsigned int jvar)
{
